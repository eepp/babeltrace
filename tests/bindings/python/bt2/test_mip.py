...
class MipTestCase(unittest.TestCase):
    def test_get_greatest_operative_mip_version(self):
        class Source1(bt2._UserSourceComponent, message_iterator_class=bt2._UserMessageIterator):
            @classmethod
            def _user_get_supported_mip_versions(cls, params, obj, log_level):
                return [0, 1]

        class Source2(bt2._UserSourceComponent, message_iterator_class=bt2._UserMessageIterator):
            @classmethod
            def _user_get_supported_mip_versions(cls, params, obj, log_level):
                return [0, 2]

        class Source3(bt2._UserSourceComponent, message_iterator_class=bt2._UserMessageIterator):
            pass
